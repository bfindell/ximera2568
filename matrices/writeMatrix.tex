...
\begin{enumerate}
\item First vertex: The origin must be mapped to the origin.  
\item Second and third vertex: The images $Ae_1$ and $Ae_2$ must be vectors from the origin. 
\item Fourth vertex:  By linearity, $A(e_1+e_2) = Ae_1+Ae_2$, which means that the four vertex must be the vector sum of the first two.  By the parallelogram rule, $Ae_1+Ae_2$ is the diagonal of the parallelogram formed by $Ae_1$ and $Ae_2$.  
\end{enumerate}
\begin{question}
